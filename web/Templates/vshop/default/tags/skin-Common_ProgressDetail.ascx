 ...
 <div class="progress-detail well">
    ...
    <div class="progress-follow well">
		...
		<div class="follow-content">
			...
			<p <%#Eval("AuditTime").ToString()!=""?"":"style=\"display:none\"" %>><span>通过平台审核</span><%#Eval("AuditTime")%></p>
			<p <%#Eval("AuditTime").ToString()!=""?"":"style=\"display:none\"" %>><span>等待平台退款</span><%#Eval("AuditTime")%></p>

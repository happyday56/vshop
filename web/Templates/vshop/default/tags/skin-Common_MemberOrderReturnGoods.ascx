...
<%@ Register TagPrefix="Hi" Namespace="Hidistro.UI.Common.Controls" Assembly="Hidistro.UI.Common.Controls" %>
    	...
    	<div class="choose_goods_content">
	    	 <a href='<%# Globals.ApplicationPath + "/Vshop/ProductReview.aspx?OrderId="+Request["OrderId"]+"&&ProductId=" + Eval("ProductId") %>'> <Hi:ListImage ID="ListImage1" runat="server" DataField="ThumbnailsUrl" /></a>
	    	<div class="info">

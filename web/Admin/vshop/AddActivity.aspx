<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/Admin/vshop/AddActivity.aspx.cs"
    Inherits="Hidistro.UI.Web.Admin.AddActivity" MasterPageFile="~/Admin/Admin.Master" %>
        ...
        <div class="columnright">
            ...
            <div class="formitem validator2">
                <ul>
                    ...
                    <li><span class="formitemtitle Pw_100">封面图文：</span> 
                ...
                <ul class="btn Pa_100 clear">
                    <asp:Button ID="btnAddActivity" runat="server" Text="添加" OnClientClick="return checkForm();" CssClass="submit_DAqueding" />
                </ul>
            </div>
        </div>
    </div>

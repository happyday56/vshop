<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddLotteryTicket.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AddLotteryTicket" %>
        ...
        <div class="columnright">
          ...
          <ui:webcalendar runat="server" CssClass="forminput" ID="calendarStartDate" /><span>（00:00）</span>
                ...
                <ul class="btn Pa_100 clearfix">
                    <asp:Button ID="btnAddActivity" runat="server" OnClientClick="return checkForm();"

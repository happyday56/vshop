...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator3">
        <ul>
          <li> <span class="formitemtitle Pw_128"><em >*</em>投票标题：</span>
           ...
           <li  style="display:none"> <span class="formitemtitle Pw_128">是否开启：</span>
             <asp:CheckBox ID="checkIsBackup" Checked="true" runat="server" />
          </li>
          <li> <span class="formitemtitle Pw_128"><em >*</em>最多可选项数：</span>
            <asp:TextBox ID="txtMaxCheck" runat="server" Text=""  CssClass="forminput" />
      ...
      <ul class="btn Pa_128">
         <asp:Button ID="btnAddVote"  runat="server" Text="添 加"  OnClientClick="return CheckForm()"  CssClass="submit_DAqueding"/>  
        </ul>
      </div>
...
<script type="text/javascript" language="javascript">
    ...
    function InitValidators() {
        ...
        initValid(new InputValidator('ctl00_contentHolder_txtKeys', 1, 60, false, null, '关键字，长度限制在60个字符以内'));

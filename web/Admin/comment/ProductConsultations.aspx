<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.ProductConsultations" MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <!--数据列表区域-->
    <div class="datalist">
     <UI:Grid ID="grdConsultation" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="ConsultationId" HeaderStyle-CssClass="table_title" CssClass="goods-list" GridLines="None" Width="100%">
                    <Columns>
                        <asp:TemplateField SortExpression="ProductName" HeaderText="咨询商品" HeaderStyle-CssClass="td_right td_left">
                        <itemstyle  CssClass="Name" />
                            <ItemTemplate >
                                    <div style="float:left;"><Hi:ListImage ID="ListImage1" runat="server" DataField="ThumbnailUrl40" /></div>                                   
                                    <div style="float:left;margin-left:10px;">
                                      <%# Eval("ProductCode")%> <br />
                                      <a href='<%#string.Format("../../vshop/ProductDetails.aspx?productId={0}",Eval("productId"))%>' target="_blank"><asp:Literal ID="lblProductName" runat="server" Text='<%# Eval("ProductName") %>' /></a>
                                    </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField  HeaderText="咨询内容" HeaderStyle-CssClass="td_right td_left">
                        ...
                        <asp:TemplateField HeaderStyle-Width="95px" HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
           
                            <ItemTemplate>
                                <span class="submit_fuihu"><a href="javascript:DialogFrame('<%# Globals.GetAdminAbsolutePath(string.Format("/comment/ReplyProductConsultations.aspx?ConsultationId={0}", Eval("ConsultationId")))%>','回复客户咨询',null,null)">回复</a></span>

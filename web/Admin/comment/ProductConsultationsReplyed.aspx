     ...
     <UI:Grid ID="grdConsultation" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="ConsultationId" HeaderStyle-CssClass="table_title" CssClass="goods-list"  GridLines="None" Width="100%">
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-Width="30%" HeaderText="咨询内容" HeaderStyle-CssClass="td_right td_left">
                            <ItemTemplate >
                               <asp:Label ID="lblConsultationText" runat="server" Text='<%# Eval("ConsultationText") %>' CssClass="line" style="text-align:left"></asp:Label>
                               <span class="p" style="text-align:left"><strong class="colorE">回复：</strong><asp:Label ID="Label1" runat="server" Text='<%# Eval("ReplyText") %>' CssClass="line"></asp:Label></span><span style="text-align:left">回复时间：<Hi:FormatedTimeLabel ID="ConsultationDateTime" Time='<%# Eval("ReplyDate") %>'

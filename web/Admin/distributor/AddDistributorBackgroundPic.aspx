...
<asp:Content ID="Content1" ContentPlaceHolderID="headHolder" runat="server">
    ...
    <script src="../../Utility/swfupload/DisBankgroundswfupload.js" type="text/javascript"  charset="gbk"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1>添加主站背景图片</h1>
            <span class="font">管理员可为主站上传4张背景图片</span>
      </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            function loader(url) {
                var settings = {
                    upload_url: "DistributorBackgroundPicUpload.aspx",
                    post_params: {

<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ExportToYfx.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.ExportToYfx" %>
...
<div class="optiongroup mainwidth">
		<ul>
			<li class="menucurrent"><a><span>导出为分销商城数据包</span></a></li>
			<li><a href="exporttotb.aspx"><span>导出为淘宝数据包</span></a></li>
...
<div class="dataarea mainwidth">
		...
		<!--结束-->
         <div class="functionHandleArea clearfix" style="height:70px;">
			<!--分页功能-->
			<div class="pageHandleArea" style="_width:600px;width:600px;">
		...
		<!--数据列表区域-->
	  <div class="datalist">
	    <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true" GridLines="None" DataKeyNames="ProductId" CssClass="goods-list"

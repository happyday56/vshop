<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeFile="ImportFromPP.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.ImportFromPP" Title="无标题页" %>
...
<div class="optiongroup mainwidth">
		<ul>
			<li class="optionstar"><a href="ImportFromTB.aspx" class="optionnext"><span>从淘宝数据包导入</span></a></li>
...
<div class="formitem">
            <ul>
              ...
              <li> <span style="color:Red;">拍拍数据包的来源：1.易分销或Hishop系统本身导出的拍拍数据包；2.拍拍或商品助理导出的文件，把CSV文件和图片文件夹都命名为products然后选中两个打成zip的压缩包</span></li>
              <li>

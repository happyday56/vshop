	...
	<div class="dataarea mainwidth databody">
     ...
     <div class="datalist">
			...
			<div class="batchHandleArea">
				<ul>
					<li class="batchHandleButton">
                        ...
                        <span class="downproduct"  style="display:none"><asp:LinkButton runat="server" ID="btnOffShelf" Text="还原到下架区"  /></span>    
	    ...
	    <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true" GridLines="None" DataKeyNames="ProductId" CssClass="goods-list" 
                    ...
                    <Columns>
                        <asp:TemplateField ItemStyle-Width="40px" HeaderText="选择" HeaderStyle-CssClass="td_right td_left">
                            <itemtemplate>

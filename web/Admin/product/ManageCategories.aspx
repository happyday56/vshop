...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
        ...
        <div class="datalist">
            ...
            <UI:Grid ID="grdTopCategries" DataKeyNames="CategoryId" runat="server" ShowHeader="true"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="是否首页显示" ItemStyle-Width="10%" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <span>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("input[id='<%=txtthird.ClientID%>']").blur(checkCommission);
            $("input[id='<%=txtsecond.ClientID%>']").blur(checkCommission);
            $("input[id='<%=txtfirst.ClientID%>']").blur(checkCommission);

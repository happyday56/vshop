        ...
        <div class="datafrom">
            <div class="formitem">
                <ul id="pluginContainer" class="attributeContent2">
                    <li class="clearfix"><span class="formitemtitle Pw_140">发送方式：</span>
                        <select id="ddlSms" name="ddlSms"></select>
                    </li>
                    <li rowtype="attributeTemplate" style="display: none; margin-bottom: 10px;" class="clearfix"><span class="formitemtitle Pw_140">$Name$：</span>
                        $Input$
                    </li>
                </ul>
            ...
            <div class="formitem">
                <ul>
                    <li class="clearfix"><span class="formitemtitle Pw_140">接收手机号：</span>
                        <asp:TextBox ID="txtTestCellPhone" runat="server" CssClass="forminput"></asp:TextBox>
                    </li>
                    <li class="clearfix"><span class="formitemtitle Pw_140">发送内容：</span>

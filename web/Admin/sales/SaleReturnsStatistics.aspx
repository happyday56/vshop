<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SaleReturnsStatistics.aspx.cs" Inherits="Hidistro.UI.Web.Admin.SaleReturnsStatistics" %>
        ...
        <div class="datalist">
            ...
            <asp:GridView ID="grdOrderLineItem" runat="server" AutoGenerateColumns="false" ShowHeader="true" AllowSorting="true" GridLines="None" HeaderStyle-CssClass="table_title">
                <Columns>
                    ...
                    <asp:BoundField HeaderText="发货数量" DataField="ProductQuantity" HeaderStyle-CssClass="td_right td_left" />
                    <Hi:MoneyColumnForAdmin HeaderText="商品单价" DataField="ProductPrice" HeaderStyle-CssClass="td_right td_left" />
                    ...
                    <asp:BoundField HeaderText="退货(款)状态" DataField="HandleStatusName" HeaderStyle-CssClass="td_right td_left" />
                </Columns>
            </asp:GridView>

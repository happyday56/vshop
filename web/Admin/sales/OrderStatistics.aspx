...
<!--选项卡-->
  ...
  <span>查询有购买记录客户的订单统计，您可以按时间查询客户的总订单数和总订单金额。</span>
      ...
      <div class="searcharea clearfix ">
		    ...
		    <li><span>昵称：</span><span><asp:TextBox ID="txtUserName" runat="server" CssClass="forminput"></asp:TextBox></span></li>
	  ...
	  <table cellspacing="0" border="0" id="TabOrders" style="width:100%;border-collapse:collapse;">
		<tr class="table_title">
			<th class="td_right td_left" scope="col">订单号</th><th class="td_right td_left" scope="col">下单时间</th><th class="td_right td_left" scope="col">总订单金额</th><th class="td_right td_left" scope="col">昵称</th><th class="td_right td_left" scope="col">收货人</th><th class="td_left td_right_fff" scope="col">利润</th>
		</tr>

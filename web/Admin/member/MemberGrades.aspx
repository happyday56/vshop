...
<span>使用会员等级区分买家的级别，不同级别的买家可以享受不同的折扣率.</span></div>
	  ...
	  <!--数据列表区域-->
  <div class="datalist">
    <UI:Grid ID="grdMemberRankList" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="GradeId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
              <Columns>
                  <asp:TemplateField HeaderText="等级名称" ItemStyle-Width="14%">
                        <ItemTemplate>
                           <asp:Literal ID="litName" Text='<%#Eval("Name") %>' runat="server"></asp:Literal>
                        </ItemTemplate>
                  </asp:TemplateField>
                  <UI:YesNoImageColumn DataField="IsDefault" HeaderText="默认会员等级" HeaderStyle-Width="16%"/>
                  ...
                  <asp:TemplateField HeaderText="备注" ItemStyle-Width="28%">
                        <ItemTemplate>

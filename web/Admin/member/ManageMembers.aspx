          ...
          <span>是否领取会员卡：</span>
                ...
                <div class="batchHandleArea">
                    <ul>
                        <li class="batchHandleButton selectButton">
                            ...
                            <span class="delete">
                                <Hi:ImageLinkButton ID="lkbDelectCheck1" IsShow="true" Height="25px" runat="server" Text="删除" /></span>
                            <span id="Span1" class="sendsite" runat="server"><a href="javascript:void(0);" onclick="return SendMessage()">短信群发</a></span>
                            <span id="Span2" class="sendsite" runat="server" style="display:none;"><!--a href="javascript:void(0);" onclick="return SendEmail()">邮件群发</a--></span>
                        </li>
                    </ul>
                </div>
            ...
            <UI:Grid ID="grdMemberList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="UserId" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="OpenID" ShowHeader="true">
                        <ItemTemplate>
                            <div></div>
                    ...
                    <asp:TemplateField>
                        <HeaderTemplate><%=VPName%></HeaderTemplate>
                        <ItemTemplate><%# Eval("VirtualPoints") %></ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="border_top border_bottom" HeaderStyle-Width="95">
                        ...
                        <ItemTemplate>
                            ...
                            <span class="submit_shanchu" style="display: none">
                                <Hi:ImageLinkButton runat="server" ID="Delete" IsShow="true" Text="删除" CommandName="Delete" /></span>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </UI:Grid>
                ...
                <ul>
                    <li class="batchHandleButton">
                        ...
                        <span class="delete" style="display: none">
                            <Hi:ImageLinkButton ID="lkbDelectCheck" IsShow="true" Height="25px" runat="server" Text="删除" /></span>
                        <span id="Span3" class="sendsite" runat="server"><a href="javascript:void(0);" onclick="return SendMessage()">短信群发</a></span>
                        <span id="Span4" class="sendsite" runat="server" style="display:none;"><!--a href="javascript:void(0);" onclick="return SendEmail()">邮件群发</a--></span>
                    </li>
                </ul>
            </div>
        </div>

		 ...
		 <div class="pageNumber" style="float:right;"> 
		  ...
		  <div class="batchHandleArea">
		    <ul>
              ...
              <span id="Span3" class="sendsite"  runat="server" style="display:none;"><a href="javascript:void(0);" onclick="return SendMessage()">短信群发</a></span>
			...
			<div class="batchHandleArea">
				<ul>
					<li class="batchHandleButton">
					   ...
					   <span id="Span1" class="sendsite" runat="server" style="display:none;"><a href="javascript:void(0);"  onclick="return SendMessage()">短信群发</a></span>

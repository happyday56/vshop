<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddGroupBuy.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AddGroupBuy" %>
            ...
            <div class="formitem validator5" style="padding-left: 15px;">
                <ul>
                  <li> <asp:TextBox ID="ProductId" runat="server" ClientIDMode="Static" style="display:none;"  ></asp:TextBox></li>
                    <li>
                    <span  class="formitemtitle Pw_140">商品名称：</span><label id="productName"></label>
                        <div class="btn">
                            <a id="addProduct" href="javascript:void(0)" onclick="ShowAddDiv()" style="font-size: 12px; color: #fff; display:inline-block;"
                                class="submit_jia">添加团购商品</a>
                        </div>
                    </li>
                ...
                <ul class="btn Pa_100 clear">
                    <li>
                        <asp:Button ID="btnAddGroupBuy" runat="server" Text="添加" OnClientClick="return PageIsValid();"

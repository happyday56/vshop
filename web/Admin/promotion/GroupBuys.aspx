<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="GroupBuys.aspx.cs" Inherits="Hidistro.UI.Web.Admin.GroupBuys" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="dataarea mainwidth databody">
        ...
        <div class="datalist">
            <div class="searcharea clearfix br_search">
                <ul class="a_none_left">
                    <li><span>团购状态：</span><span>
                        <abbr class="formselect">
                            <asp:DropDownList runat="server" ID="GroupBuyState" Width="107" />
                        </abbr>
                    </span></li>
                    <li><span>商品名称：</span><span><asp:TextBox ID="txtProductName" runat="server" CssClass="forminput" /></span></li>
                    <li>
                        <asp:Button ID="btnSearch" runat="server" CssClass="searchbutton" Text="查询" /></li>
                </ul>
            </div>
                ...
                <div class="batchHandleArea">
                    <ul>
                        <li class="batchHandleButton"><span class="signicon"></span><span class="allSelect">
                            <a onclick="CheckClickAll()" href="javascript:void(0)">全选</a></span> <span class="reverseSelect">
                                <a onclick="CheckReverse()" href="javascript:void(0)">反选</a></span> <span class="delete">
                                    <Hi:ImageLinkButton ID="lkbtnDeleteCheck" IsShow="true" runat="server">删除</Hi:ImageLinkButton></span>
                        </li>
                    </ul>
                </div>
        ...
        <asp:LinkButton ID="btnOrder" runat="server" Text="保存排序" />
            ...
            <UI:Grid ID="grdGroupBuyList" runat="server" ShowHeader="true" AutoGenerateColumns="false"
                SortOrderBy="DisplaySequence" DataKeyNames="GroupBuyId" HeaderStyle-CssClass="table_title"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="商品名称" HeaderStyle-CssClass="td_right td_left" ItemStyle-Width="30%">
                        <ItemTemplate>
                            <a href='<%#"/Vshop/GroupBuyProductDetails.aspx?groupBuyId="+Eval("GroupBuyId")%>'
                                target="_blank">
                                <Hi:SubStringLabel ID="lblHelpCategory" Field="ProductName" StrLength="60" StrReplace="..."
                                    runat="server"></Hi:SubStringLabel>
                            </a>
                    ...
                    <asp:TemplateField HeaderText="状态" HeaderStyle-CssClass="td_right td_left" ItemStyle-Width="7%">
                        <ItemTemplate>
                            <Hi:GroupBuyStatusLabel GroupBuyStatusCode='<%#Eval("Status") %>' GroupBuyStartTime='<%# Eval("StartDate") %>'
                                runat="server" ID="GroupBuyStatusLabel" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="开始时间" ItemStyle-Width="9%" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <Hi:FormatedTimeLabel ID="lblStartDate" Time='<%#Eval("StartDate") %>' FormatDateTime="yyyy/MM/dd HH时"
                                runat="server"></Hi:FormatedTimeLabel>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="结束时间" ItemStyle-Width="9%" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <Hi:FormatedTimeLabel ID="lblEndDate" FormatDateTime="yyyy/MM/dd HH时" Time='<%#Eval("EndDate") %>'
                                runat="server"></Hi:FormatedTimeLabel>
                        </ItemTemplate>
                    </asp:TemplateField>
                 <%--   <asp:TemplateField  HeaderText="违约金" ItemStyle-Width="5%" HeaderStyle-CssClass="td_right td_left">
                    ...
                    <asp:BoundField HeaderText="订购商品" DataField="SoldCount" ItemStyle-Width="5%"
                    ...
                    <asp:TemplateField HeaderText="订单" ItemStyle-Width="6%" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <a href="javascript:DialogFrame('sales/ManageOrder.aspx?orderStatus=0&GroupBuyId=<%# Eval("GroupBuyId") %>','团购订单',null,null);">
                                <%#Eval("OrderCount") %>(查看)</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作" ItemStyle-Width="10%" HeaderStyle-CssClass="td_left td_right_fff">
                        <ItemTemplate>
                            <span class="submit_bianji"><a href='<%# "EditGroupBuy.aspx?GroupBuyId=" + Eval("GroupBuyId")%> '>
                                编辑</a></span> <span class="submit_shanchu">
                                    <Hi:ImageLinkButton ID="lkDelete" IsShow="true" Text="删除" CommandName="Delete" runat="server" /></span>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </UI:Grid>

...
<head>
    <title>微分销 安装向导</title>
    <script type="text/javascript" language="javascript" src="../Utility/jquery-1.6.4.min.js"></script>
...
<body>
    ...
    <div class="header">
        <div class="header_c">
          <div class="l_logo"><img src="images/process/logo.png" /></div>
          <div class="r_word">
             <p><a href="#" onclick="ConfrimInstall()">退出安装</a></p>
             <div><img src="images/process/word.jpg" /></div>
          </div>
        </div>
    </div>
    ...
    <div class="main">
        <div class="main_c">
            ...
            <asp:Label ID="lblErrMessage" runat="server" CssClass="exp"></asp:Label>
                <div class="config_info">
                    <div class="c_i_l">
                        ...
                        <h2>
                            数据库配置</h2>
                        <p>
                            <span>数据库地址：</span><asp:TextBox ID="txtDbServer" runat="server" value="." CssClass="txt" /><em>*</em></p>
                        <p>
                    ...
                    <div class="c_i_r">
                        <h2>
                            管理员设置</h2>
                        <p>
                            <span>用户名：</span><asp:TextBox ID="txtUsername" value="admin" runat="server" CssClass="txt" /><em>*</em></p>
                        <p>
                            <span>电子邮件：</span><asp:TextBox ID="txtEmail" value="admin@admin.com" runat="server" CssClass="txt" /><em>*</em></p>
                        <p>
                ...
                <p class="addDemo"><asp:CheckBox ID="chkIsAddDemo" runat="server" checked />&nbsp;&nbsp;<span>添加演示数据</span></p>
    ...
    <div class="footer">
      <p>Copyright 2015 All Rrghts Reserved.</p>
    </div>
    </form>
</body>
</html>
namespace Hidistro.SaleSystem.Vshop
{
    ...
    public static class CategoryBrowser
    {
        ...
        public static DataTable GetCategoriesByDisplayHome()
        {
            DataTable categories = HiCache.Get("DataCache-CategoriesByDisplayHome") as DataTable;
            //if (categories == null)
            //{
                categories = new CategoryDao().GetCategoriesByDisplayHome();
                //HiCache.Insert("DataCache-CategoriesByDisplayHome", categories, 360, CacheItemPriority.Normal);
            //}
            return categories;
        }

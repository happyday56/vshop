namespace Hidistro.ControlPanel.Sales
{
    ...
    public sealed class SalesHelper
    {
        ...
        public static DataTable SearchSaleStatisticsData(SearchStatisticsQuery query)
        {
            return new SaleStatisticDao().SearchSaleStatisticsData(query);
        }

        public static DataTable SearchDistributorSaleStatisticsData(SearchStatisticsQuery query)
        {
            return new SaleStatisticDao().SearchDistributorSaleStatisticsData(query);
        }

        public static DbQueryResult SearchSaleReturnsStatisticsData(SaleStatisticsQuery query)
        {
            return new SaleStatisticDao().SearchSaleReturnsStatisticsData(query);
        }

        public static DbQueryResult SearchSaleReturnsOrderStatisticsData(SaleStatisticsQuery query)
        {
            return new SaleStatisticDao().SearchSaleReturnsOrderStatisticsData(query);
        }

        public static DbQueryResult SearchSaleOrderStatisticsData(SaleStatisticsQuery query)
        {
            return new SaleStatisticDao().SearchSaleOrderStatisticsData(query);
        }
    }
}

namespace Hidistro.ControlPanel.Commodities
{
    ...
    public static class ProductHelper
    {
        ...
        public static DbQueryResult GetProducts(ProductQuery query, bool isAP = false)
        {
            return new ProductDao().GetProducts(query, isAP);
        }
        ...
        public static bool UpdateProductLetter(ProductInfo product)
        {

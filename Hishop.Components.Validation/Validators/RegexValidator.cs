...
namespace Hishop.Components.Validation.Validators
{
    public class RegexValidator : ValueValidator<string>
    {
        ...
        public RegexValidator(string pattern, RegexOptions options)
            : this(pattern, options, (string)null)
        {
        }
        ...
        public RegexValidator(string patternResourceName, Type patternResourceType, RegexOptions options)
            : this(patternResourceName, patternResourceType, options, (string)null)
        {
        }
        ...
        protected override void DoValidate(string objectToValidate, object currentTarget, string key, ValidationResults validationResults)
        {
            ...
            if (!flag2)
            {
                Regex regex = new Regex(this.GetPattern(), this.options);
        ...
        {
            return string.Format(CultureInfo.CurrentCulture, base.MessageTemplate, new object[] { objectToValidate, key, base.Tag, this.pattern, this.options });
        }

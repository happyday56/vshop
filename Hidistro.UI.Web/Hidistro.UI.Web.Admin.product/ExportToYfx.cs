...
namespace Hidistro.UI.Web.Admin.product
{
	...
	public class ExportToYfx : AdminPage
	{
		...
		protected System.Web.UI.WebControls.CheckBox chkExportCostPrice;
		...
		private void BindExporter()
		{
			...
			System.Collections.Generic.Dictionary<string, string> exportAdapters = TransferHelper.GetExportAdapters(new YfxTarget("1.2"), "分销商城");
		...
		private void btnExport_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				{
					bool includeCostPrice = this.chkExportCostPrice.Checked;
					bool includeStock = this.chkExportStock.Checked;
					bool flag3 = this.chkExportImages.Checked;

namespace ASPNET.WebControls
{
    ...
    public class GroupRadioButton : CompositeControl
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                clientScript.RegisterClientScriptBlock(this.Page.GetType(), "ResetGroupScript", Script);
            }
        }
        ...
        private void RenderInputTag(HtmlTextWriter htw)
        {
            ...
            htw.AddAttribute(HtmlTextWriterAttribute.Onclick, "ResetGroup('" + this.container.ClientID + "', '" + this.txtChecked.ClientID + "');");
        ...
        public bool Checked
        {
            get
            {
                if (string.IsNullOrEmpty(this.txtChecked.Value))
                {
                    return false;
                }
                return bool.Parse(this.txtChecked.Value);
            }
            set
            {

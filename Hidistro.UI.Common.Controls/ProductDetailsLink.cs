namespace Hidistro.UI.Common.Controls
{
    ...
    public class ProductDetailsLink : HyperLink
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            {
                base.NavigateUrl = Globals.ApplicationPath + "/Vshop/ProductDetails.aspx?ProductId=" + this.ProductId;
                string str = Globals.ApplicationPath + "/Vshop/ProductDetails.aspx?ProductId=" + this.ProductId;

namespace Hidistro.UI.Common.Controls
{
    ...
    public class ImageUploader : WebControl
    {
        ...
        [CompilerGenerated]
        private Hidistro.UI.Common.Controls.UploadType AJK4pBZQRuLk5fMo8iYo;
        ...
        protected override void CreateChildControls()
        {
            ...
            string str2 = A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("YgBhAGMAawBnAHIAbwB1AG4AZAA6AHUAcgBsACgA") + webResourceUrl + A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("KQA7AGIAYQBjAGsAZwByAG8AdQBuAGQALQByAGUAcABlAGEAdAA6AG4AbwAtAHIAZQBwAGUAYQB0ADsAIABiAGEAYwBrAGcAcgBvAHUAbgBkAC0AcABvAHMAaQB0AGkAbwBuADoAMgAwAHAAeAAgAC0AOAAwAHAAeAA=");
        ...
        public override void RenderControl(HtmlTextWriter writer)
        {
            ...
            {
                string str2 = A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("JAAoAGQAbwBjAHUAbQBlAG4AdAApAC4AcgBlAGEAZAB5ACgAZgB1AG4AYwB0AGkAbwBuACgAKQAgAHsAIABJAG4AaQB0AFUAcABsAG8AYQBkAGUAcgAoACIA") + this.ID + A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("IgAsACAAIgA=") + this.UploadType.ToString().ToLower() + A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("IgApADsA");
                if (this.IsUploaded)
                {
                    string str3 = str2;
                    str2 = str3 + A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("VQBwAGQAYQB0AGUAUAByAGUAdgBpAGUAdwAoACcA") + this.ID + A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("JwAsACAAJwA=") + this.ThumbnailUrl100 + A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("JwApADsA");
                }
        ...
        public string UploadedImageUrl
        {
            ...
            set
            {
                if (this.AAZ0JeEma(2x58C7QQ)d9L4MH(value))
                {
                    ...
                    this.ABOZyE4bfGcbd5Z8N5SO7b2 = value.Replace(A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwBpAG0AYQBnAGUAcwAvAA=="), A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwB0AGgAdQBtAGIAcwA0ADAALwA0ADAAXwA="));
                    this.AC2pFbvHCa1v4C1DIZ8SngolueQb = value.Replace(A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwBpAG0AYQBnAGUAcwAvAA=="), A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwB0AGgAdQBtAGIAcwA2ADAALwA2ADAAXwA="));
                    this.AD)2Z(NKy = value.Replace(A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwBpAG0AYQBnAGUAcwAvAA=="), A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwB0AGgAdQBtAGIAcwAxADAAMAAvADEAMAAwAF8A"));
                    this.AE)AZJK0MajbU = value.Replace(A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwBpAG0AYQBnAGUAcwAvAA=="), A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwB0AGgAdQBtAGIAcwAxADYAMAAvADEANgAwAF8A"));
                    this.AFCkJKk = value.Replace(A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwBpAG0AYQBnAGUAcwAvAA=="), A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwB0AGgAdQBtAGIAcwAxADgAMAAvADEAOAAwAF8A"));
                    this.AGeIcrrVo5pC(snrJL = value.Replace(A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwBpAG0AYQBnAGUAcwAvAA=="), A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwB0AGgAdQBtAGIAcwAyADIAMAAvADIAMgAwAF8A"));
                    this.AHxCaphXxC5uvu = value.Replace(A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwBpAG0AYQBnAGUAcwAvAA=="), A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwB0AGgAdQBtAGIAcwAzADEAMAAvADMAMQAwAF8A"));
                    this.AIYbPEZFPIB(c7C = value.Replace(A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwBpAG0AYQBnAGUAcwAvAA=="), A0CvdP16Is.AC2pFbvHCa1v4C1DIZ8SngolueQb.AGeIcrrVo5pC(snrJL("LwB0AGgAdQBtAGIAcwA0ADEAMAAvADQAMQAwAF8A"));
                }
            }
        }

namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    [ParseChildren(true)]
    public class VProgressDetail : VWeiXinOAuthTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            if (this.Page.Request.QueryString["ReturnsId"] != null)
            {
                ...
                this.rptOrderReturns.DataSource = ShoppingProcessor.GetOrderReturnTable(currentMember.UserId, this.Page.Request.QueryString["ReturnsId"]);
